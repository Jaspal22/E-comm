    ...
    return (
        ...
        <form onSubmit={onSubmitHandler} className='flex flex-col w-full items-start gap-3' >
            ...
            <div className='w-full'>
                ...
                <textarea onChange={(event) => setDesctiption(event.target.value)} value={description} className='w-full max-w-[500px] px-3 py-2' type='text' placeholder='Description...' required/>            
            </div>
            ...
            <div className='w-full'>
                ...
                <select onChange={(event) => setCategory(event.target.value)} value={category} className='w-full px-3 py-2' required>
            ...
            <div className='w-full'>
                ...
                <select onChange={(event) => setSubCategory(event.target.value)} value={subCategory} className='w-full px-3 py-2' required>
